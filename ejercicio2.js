...
class BookList {
  ...
  finishCurrentBook() {
    ...
    this.allBooks.forEach((libro) => {
      if (libro.read == false) this.nextBook = libro;
    });
  }
}

let Book1 = new Book(
  "My Little Harry Prince Potter",
  "Fantasy",
  "Otto",
  false,
  ""
